...
pub struct DcimPowerOutletTemplatesList200Response {
    #[serde(rename = "count")]
    pub count: i32,
...
impl DcimPowerOutletTemplatesList200Response {
    pub fn new(count: i32, results: Vec<crate::models::PowerOutletTemplate>) -> DcimPowerOutletTemplatesList200Response {
