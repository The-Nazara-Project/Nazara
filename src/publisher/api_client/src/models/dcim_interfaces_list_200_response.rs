...
pub struct DcimInterfacesList200Response {
    #[serde(rename = "count")]
    pub count: i32,
...
impl DcimInterfacesList200Response {
    pub fn new(count: i32, results: Vec<crate::models::Interface>) -> DcimInterfacesList200Response {
