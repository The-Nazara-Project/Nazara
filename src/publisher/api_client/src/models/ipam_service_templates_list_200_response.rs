...
pub struct IpamServiceTemplatesList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::ServiceTemplate>,
}

impl IpamServiceTemplatesList200Response {
    pub fn new(count: i32, results: Vec<crate::models::ServiceTemplate>) -> IpamServiceTemplatesList200Response {
