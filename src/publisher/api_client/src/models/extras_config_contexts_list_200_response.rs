...
pub struct ExtrasConfigContextsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::ConfigContext>,
}

impl ExtrasConfigContextsList200Response {
    pub fn new(count: i32, results: Vec<crate::models::ConfigContext>) -> ExtrasConfigContextsList200Response {
