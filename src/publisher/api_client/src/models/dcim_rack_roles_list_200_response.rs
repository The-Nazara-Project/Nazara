...
pub struct DcimRackRolesList200Response {
    #[serde(rename = "count")]
    pub count: i32,
...
impl DcimRackRolesList200Response {
    pub fn new(count: i32, results: Vec<crate::models::RackRole>) -> DcimRackRolesList200Response {
