...
pub struct IpamL2vpnsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::L2Vpn>,
}

impl IpamL2vpnsList200Response {
    pub fn new(count: i32, results: Vec<crate::models::L2Vpn>) -> IpamL2vpnsList200Response {
