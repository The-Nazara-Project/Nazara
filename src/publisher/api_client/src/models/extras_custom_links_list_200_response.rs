...
pub struct ExtrasCustomLinksList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::CustomLink>,
}

impl ExtrasCustomLinksList200Response {
    pub fn new(count: i32, results: Vec<crate::models::CustomLink>) -> ExtrasCustomLinksList200Response {
