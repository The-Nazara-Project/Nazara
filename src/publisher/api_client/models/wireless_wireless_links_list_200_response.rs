...
pub struct WirelessWirelessLinksList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::WirelessLink>,
}

impl WirelessWirelessLinksList200Response {
    pub fn new(count: i32, results: Vec<crate::models::WirelessLink>) -> WirelessWirelessLinksList200Response {
