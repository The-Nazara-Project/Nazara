...
pub struct DcimDeviceBaysList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::DeviceBay>,
}

impl DcimDeviceBaysList200Response {
    pub fn new(count: i32, results: Vec<crate::models::DeviceBay>) -> DcimDeviceBaysList200Response {
