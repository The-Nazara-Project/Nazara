...
pub struct IpamFhrpGroupsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::FhrpGroup>,
}

impl IpamFhrpGroupsList200Response {
    pub fn new(count: i32, results: Vec<crate::models::FhrpGroup>) -> IpamFhrpGroupsList200Response {
