...
pub struct IpamRouteTargetsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
...
impl IpamRouteTargetsList200Response {
    pub fn new(count: i32, results: Vec<crate::models::RouteTarget>) -> IpamRouteTargetsList200Response {
