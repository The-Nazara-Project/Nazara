...
pub struct DcimModuleBaysList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::ModuleBay>,
}

impl DcimModuleBaysList200Response {
    pub fn new(count: i32, results: Vec<crate::models::ModuleBay>) -> DcimModuleBaysList200Response {
