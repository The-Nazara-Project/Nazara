...
pub struct DcimFrontPortsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::FrontPort>,
}

impl DcimFrontPortsList200Response {
    pub fn new(count: i32, results: Vec<crate::models::FrontPort>) -> DcimFrontPortsList200Response {
