...
pub struct DcimPowerPortsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::PowerPort>,
}

impl DcimPowerPortsList200Response {
    pub fn new(count: i32, results: Vec<crate::models::PowerPort>) -> DcimPowerPortsList200Response {
