...
pub struct DcimPowerFeedsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::PowerFeed>,
}

impl DcimPowerFeedsList200Response {
    pub fn new(count: i32, results: Vec<crate::models::PowerFeed>) -> DcimPowerFeedsList200Response {
