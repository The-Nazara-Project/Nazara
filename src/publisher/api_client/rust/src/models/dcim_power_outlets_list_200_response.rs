...
pub struct DcimPowerOutletsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::PowerOutlet>,
}

impl DcimPowerOutletsList200Response {
    pub fn new(count: i32, results: Vec<crate::models::PowerOutlet>) -> DcimPowerOutletsList200Response {
