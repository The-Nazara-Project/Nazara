...
pub struct IpamRirsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::Rir>,
}

impl IpamRirsList200Response {
    pub fn new(count: i32, results: Vec<crate::models::Rir>) -> IpamRirsList200Response {
