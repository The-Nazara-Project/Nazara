...
pub struct CircuitsProvidersList200Response {
    #[serde(rename = "count")]
    pub count: i32,
...
impl CircuitsProvidersList200Response {
    pub fn new(count: i32, results: Vec<crate::models::Provider>) -> CircuitsProvidersList200Response {
