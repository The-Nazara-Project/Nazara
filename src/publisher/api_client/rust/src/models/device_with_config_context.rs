...
impl DeviceWithConfigContext {
    pub fn new(name: Option<String>, device_type: crate::models::NestedDeviceType, device_role: crate::models::NestedDeviceRole, site: Option<crate::models::NestedSite>) -> DeviceWithConfigContext {
