...
pub struct IpamVlanGroupsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::VlanGroup>,
}

impl IpamVlanGroupsList200Response {
    pub fn new(count: i32, results: Vec<crate::models::VlanGroup>) -> IpamVlanGroupsList200Response {
