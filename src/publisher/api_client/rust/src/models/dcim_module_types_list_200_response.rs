...
pub struct DcimModuleTypesList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::ModuleType>,
}

impl DcimModuleTypesList200Response {
    pub fn new(count: i32, results: Vec<crate::models::ModuleType>) -> DcimModuleTypesList200Response {
