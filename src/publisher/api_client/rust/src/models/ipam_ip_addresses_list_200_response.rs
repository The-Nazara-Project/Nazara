...
pub struct IpamIpAddressesList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::IpAddress>,
}

impl IpamIpAddressesList200Response {
    pub fn new(count: i32, results: Vec<crate::models::IpAddress>) -> IpamIpAddressesList200Response {
