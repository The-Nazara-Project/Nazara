...
pub struct WritableFhrpGroupAssignment {
...
impl WritableFhrpGroupAssignment {
    pub fn new(group: i32, interface_type: String, interface_id: i32, priority: i32) -> WritableFhrpGroupAssignment {
