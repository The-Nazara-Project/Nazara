...
pub struct DcimRearPortsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
...
impl DcimRearPortsList200Response {
    pub fn new(count: i32, results: Vec<crate::models::RearPort>) -> DcimRearPortsList200Response {
