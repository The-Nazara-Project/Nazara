...
pub struct VirtualizationInterfacesList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::VmInterface>,
}

impl VirtualizationInterfacesList200Response {
    pub fn new(count: i32, results: Vec<crate::models::VmInterface>) -> VirtualizationInterfacesList200Response {
