...
pub struct DcimDeviceRolesList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::DeviceRole>,
}

impl DcimDeviceRolesList200Response {
    pub fn new(count: i32, results: Vec<crate::models::DeviceRole>) -> DcimDeviceRolesList200Response {
