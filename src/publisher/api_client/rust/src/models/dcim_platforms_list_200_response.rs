...
pub struct DcimPlatformsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::Platform>,
}

impl DcimPlatformsList200Response {
    pub fn new(count: i32, results: Vec<crate::models::Platform>) -> DcimPlatformsList200Response {
