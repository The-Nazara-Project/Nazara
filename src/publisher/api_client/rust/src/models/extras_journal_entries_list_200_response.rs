...
pub struct ExtrasJournalEntriesList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::JournalEntry>,
}

impl ExtrasJournalEntriesList200Response {
    pub fn new(count: i32, results: Vec<crate::models::JournalEntry>) -> ExtrasJournalEntriesList200Response {
