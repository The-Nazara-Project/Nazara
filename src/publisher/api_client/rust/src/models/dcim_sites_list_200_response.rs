...
pub struct DcimSitesList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::Site>,
}

impl DcimSitesList200Response {
    pub fn new(count: i32, results: Vec<crate::models::Site>) -> DcimSitesList200Response {
