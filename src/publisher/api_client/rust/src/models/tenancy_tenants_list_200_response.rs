...
pub struct TenancyTenantsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::Tenant>,
}

impl TenancyTenantsList200Response {
    pub fn new(count: i32, results: Vec<crate::models::Tenant>) -> TenancyTenantsList200Response {
