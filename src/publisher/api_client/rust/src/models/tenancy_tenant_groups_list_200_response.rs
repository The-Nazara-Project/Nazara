...
pub struct TenancyTenantGroupsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
...
impl TenancyTenantGroupsList200Response {
    pub fn new(count: i32, results: Vec<crate::models::TenantGroup>) -> TenancyTenantGroupsList200Response {
