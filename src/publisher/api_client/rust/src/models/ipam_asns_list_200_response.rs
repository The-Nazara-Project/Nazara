...
pub struct IpamAsnsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::Asn>,
}

impl IpamAsnsList200Response {
    pub fn new(count: i32, results: Vec<crate::models::Asn>) -> IpamAsnsList200Response {
