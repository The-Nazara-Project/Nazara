...
pub struct ExtrasWebhooksList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::Webhook>,
}

impl ExtrasWebhooksList200Response {
    pub fn new(count: i32, results: Vec<crate::models::Webhook>) -> ExtrasWebhooksList200Response {
