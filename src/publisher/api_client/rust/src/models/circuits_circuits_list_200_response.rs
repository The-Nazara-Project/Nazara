...
pub struct CircuitsCircuitsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::Circuit>,
}

impl CircuitsCircuitsList200Response {
    pub fn new(count: i32, results: Vec<crate::models::Circuit>) -> CircuitsCircuitsList200Response {
