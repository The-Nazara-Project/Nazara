...
pub struct DcimPowerPanelsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::PowerPanel>,
}

impl DcimPowerPanelsList200Response {
    pub fn new(count: i32, results: Vec<crate::models::PowerPanel>) -> DcimPowerPanelsList200Response {
