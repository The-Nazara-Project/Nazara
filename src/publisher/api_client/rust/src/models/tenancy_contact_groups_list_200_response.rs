...
pub struct TenancyContactGroupsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::ContactGroup>,
}

impl TenancyContactGroupsList200Response {
    pub fn new(count: i32, results: Vec<crate::models::ContactGroup>) -> TenancyContactGroupsList200Response {
