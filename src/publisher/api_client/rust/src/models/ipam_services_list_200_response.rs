...
pub struct IpamServicesList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::Service>,
}

impl IpamServicesList200Response {
    pub fn new(count: i32, results: Vec<crate::models::Service>) -> IpamServicesList200Response {
