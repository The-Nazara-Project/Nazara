...
pub struct TenancyContactRolesList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::ContactRole>,
}

impl TenancyContactRolesList200Response {
    pub fn new(count: i32, results: Vec<crate::models::ContactRole>) -> TenancyContactRolesList200Response {
