...
pub struct IpamIpRangesList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::IpRange>,
}

impl IpamIpRangesList200Response {
    pub fn new(count: i32, results: Vec<crate::models::IpRange>) -> IpamIpRangesList200Response {
