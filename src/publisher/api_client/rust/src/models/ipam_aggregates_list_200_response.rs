...
pub struct IpamAggregatesList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::Aggregate>,
}

impl IpamAggregatesList200Response {
    pub fn new(count: i32, results: Vec<crate::models::Aggregate>) -> IpamAggregatesList200Response {
