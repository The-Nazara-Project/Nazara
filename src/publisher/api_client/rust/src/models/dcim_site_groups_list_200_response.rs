...
pub struct DcimSiteGroupsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::SiteGroup>,
}

impl DcimSiteGroupsList200Response {
    pub fn new(count: i32, results: Vec<crate::models::SiteGroup>) -> DcimSiteGroupsList200Response {
