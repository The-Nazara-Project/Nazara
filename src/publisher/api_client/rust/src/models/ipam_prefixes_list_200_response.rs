...
pub struct IpamPrefixesList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::Prefix>,
}

impl IpamPrefixesList200Response {
    pub fn new(count: i32, results: Vec<crate::models::Prefix>) -> IpamPrefixesList200Response {
