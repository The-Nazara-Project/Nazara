...
pub struct TenancyContactsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::Contact>,
}

impl TenancyContactsList200Response {
    pub fn new(count: i32, results: Vec<crate::models::Contact>) -> TenancyContactsList200Response {
