...
pub struct DcimLocationsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
...
impl DcimLocationsList200Response {
    pub fn new(count: i32, results: Vec<crate::models::Location>) -> DcimLocationsList200Response {
