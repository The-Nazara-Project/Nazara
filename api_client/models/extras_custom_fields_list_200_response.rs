...
pub struct ExtrasCustomFieldsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::CustomField>,
}

impl ExtrasCustomFieldsList200Response {
    pub fn new(count: i32, results: Vec<crate::models::CustomField>) -> ExtrasCustomFieldsList200Response {
