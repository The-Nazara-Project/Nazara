...
pub struct ExtrasTagsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::Tag>,
}

impl ExtrasTagsList200Response {
    pub fn new(count: i32, results: Vec<crate::models::Tag>) -> ExtrasTagsList200Response {
