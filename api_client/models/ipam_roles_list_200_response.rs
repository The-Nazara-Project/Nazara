...
pub struct IpamRolesList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::Role>,
}

impl IpamRolesList200Response {
    pub fn new(count: i32, results: Vec<crate::models::Role>) -> IpamRolesList200Response {
