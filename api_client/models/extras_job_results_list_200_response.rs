...
pub struct ExtrasJobResultsList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::JobResult>,
}

impl ExtrasJobResultsList200Response {
    pub fn new(count: i32, results: Vec<crate::models::JobResult>) -> ExtrasJobResultsList200Response {
