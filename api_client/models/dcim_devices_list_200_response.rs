...
pub struct DcimDevicesList200Response {
    #[serde(rename = "count")]
    pub count: i32,
...
impl DcimDevicesList200Response {
    pub fn new(count: i32, results: Vec<crate::models::DeviceWithConfigContext>) -> DcimDevicesList200Response {
