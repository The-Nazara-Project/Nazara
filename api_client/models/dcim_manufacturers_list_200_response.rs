...
pub struct DcimManufacturersList200Response {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<crate::models::Manufacturer>,
}

impl DcimManufacturersList200Response {
    pub fn new(count: i32, results: Vec<crate::models::Manufacturer>) -> DcimManufacturersList200Response {
